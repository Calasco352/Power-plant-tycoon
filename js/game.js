...
function restorePurchasesTest(){
  if(g.autoGenerateUnlocked){toast("✓ Auto Generate entitlement found.");return}
  toast("No browser test entitlement found. StoreKit restore will be used in the iPhone app.");
}
